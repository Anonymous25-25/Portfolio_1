    ...
    >
      ...
      <div className="relative h-full flex items-center">
        ...
        <div className="relative z-20 max-w-xl ml-2 mt-45 md:ml-30">
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-400/30 text-red-400 text-xs font-medium">
            <span className="w-2 h-2 rounded-full bg-red-400 animate-pulse"></span>
            Open for Security Engagements
          </div>
          <p className="text-sm md:text-base text-gray-400 mb-4">
            Youness Boussedari | BlackSide Security
          </p>

          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            Mastering the Art of Offensive Security
            <br />
            to Build Unshakeable Defenses
          </h1>

          <p className="mt-6 text-gray-400 md:text-lg">
            Cybersecurity Engineering student specializing in penetration
            testing, vulnerability assessment, and SOC analysis. Turning
            attacker techniques into actionable defense intelligence.
          </p>
